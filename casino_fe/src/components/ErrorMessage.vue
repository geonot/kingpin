<template>
    ...
    <div v-if="visible"
         class="error-message-box flex items-center justify-between p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-900 dark:text-red-300 border border-red-300 dark:border-red-600 shadow-md"
         role="alert">
        <div class="flex items-center">
            ...
            <span class="font-medium">Error!</span> <span class="ml-2 message">{{ message }}</span>
        </div>
        <button
            type="button"
